        ...
        <div class="row w3-res-tb">
            <div class="col-sm-5 m-b-xs">
                <select class="input-sm form-control w-sm inline v-middle" onchange="location = '{{URL::to('/listbandoc-show/')}}' + '/' + this.value;">
                    ...
                    <option value="..">Xe trong bến</option>
                    <option value="..">Xe đang chạy</option>
            ...
            <table class="table table-striped b-t b-light">
                ...
                <tbody id="listBanDoc">
                    <tr>
                        ...
                        <td><button class="btn" style="background-color: #FDDC69;"><a href="{{URL::to('/xevao')}}"> Chi tiết </a></button></td>
                    </tr>
                    <tr>
                        <td>2</td>
                        <td>XE005</td>
