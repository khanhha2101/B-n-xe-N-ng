                            ...
                            <table class="table table-striped b-t b-light">
                                ...
                                <tbody id="listBanDoc">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$value->giave}}</td>
                                        <td>
                                            <button type="submit" class="btn" style="background-color: #FDDC69;"><a href="{{URL::to('/xem-chuyenxe/'.$value->macx.'&'.$value->mand)}}"> Xem </a></button>

                                            <button type="submit" class="btn" style="background-color: #00D47E;"><a href="{{URL::to('/duyet-chuyenxe/'.$value->macx.'&'.$value->mand)}}"> Duyệt </a></button>

                                            <button type="submit" class="btn" style="background-color: #FE8A8A;"><a onclick="return confirm('Bạn có chắc chắn muốn xóa không?')" href="{{URL::to('/xoa-chuyenxe/'.$value->macx.'&'.$value->mand)}}">Xóa</a></button>
                                        </td>
                                    </tr>
                                    <?php $i += 1 ?>
                                    @endif
